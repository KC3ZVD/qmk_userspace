...
#define _SYM \
    ...
    XXXXXXX,  KC_GRV, KC_QUOT, KC_DQT,  KC_DLR, KC_EXLM, KC_PLUS, KC_QUES,  KC_ASTR, KC_LCBR, KC_RCBR, XXXXXXX,  \
    XXXXXXX, KC_PIPE, KC_PERC, KC_LABK,  KC_EQL, KC_RABK, KC_MINS,   KC_AT, KC_COLN, KC_LPRN, KC_RPRN, XXXXXXX, \
...
#define L_5x12_TO_3x6_5( \
    ...
    XXXXXXX, k31, k32, k33, k34, k35, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, k36, k37, k38, k39, k3a, XXXXXXX, \
              XXXXXXX, GUI_TAB, BSC_NUM, SPC_MSE, OS_LSFT, ENT_FUN, DEL_SYM, KC_SPC, GUI_TAB, XXXXXXX
